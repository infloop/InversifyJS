...
describe("Performance", async () => {
    ...
    it("Should be able to register 1 binding in less than 1 ms", async () => {
        const result1 = registerN(1);
        expect(result1.register).to.below(1);
        expect(result1.register).to.below(1);
    });

    it("Should be able to register 5 bindings in less than 1 ms", async () => {
        const result5 = registerN(5);
        expect(result5.register).to.below(1);
    });

    it("Should be able to register 1K bindings in less than 1 ms", async () => {
        const result1K = registerN(1000);
        expect(result1K.register).to.below(1);
    });

    it("Should be able to register 5K bindings in less than 1 ms", async () => {
        const result5K = registerN(5000);
        expect(result5K.register).to.below(1);
    });

    it("Should be able to register 1 bindings in less than 1 ms", async () => {
    ...
    it("Should be able to register 10K bindings in less than 1 ms", async () => {
